...
axes1.ticklabel_format(style="plain") # turns off scientific notation
...
plt.ylabel('Time spend in nanosec per operation')
plt.xlabel('Number of elements in LPM map')
fig.savefig(fname)
return fname
#+END_SRC
