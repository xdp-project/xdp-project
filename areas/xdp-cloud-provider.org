...
This [[file:xdp-cloud-provider.org]] contains tasks for XDP-Cloud-Provider project.
This gets rendered on [[https://xdp-project.net/areas/xdp-cloud-provider.html][xdp-project.net]].
