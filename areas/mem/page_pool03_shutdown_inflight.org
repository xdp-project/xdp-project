...
** Error case after patchset splitup

I might have caused a regression in my patch, after splitting it up into a
patchset.... as I can now generate a shutdown issue.
