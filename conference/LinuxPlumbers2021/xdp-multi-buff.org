...
** Slide: XDP multi-buffers: new eBPF helpers (1/4)			   :export:
...
** Slide: XDP multi-buffers: new eBPF helpers (2/4)			   :export:
...
** Slide: XDP multi-buffers: new eBPF helpers (3/4)			   :export:
- /bpf_xdp_adjust_data/:
#+begin_src C
...
** Slide: XDP multi-buffers: new eBPF helpers (4/4)			   :export:
