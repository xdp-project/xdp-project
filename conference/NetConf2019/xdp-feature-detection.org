...
Verifier *detection strategy*, to construct XDP features in-use
...
Again remember:
- Verifier don't know if BPF-prog is used for *generic-XDP*
- Are we /forced to supply more info than =ifindex= ?/
