...
Kernel-side: Could *extend* /=xdp_buff=/ + /=xdp_frame=/ with "btf_id" or ptr
 ...
 - /Pros/: /Kernel internally/ can (likely) store *pointer to btf* struct
   - */Cons/*: This needs reference counting and race handling
