...
#+OPTIONS: reveal_center:nil reveal_control:nil reveal_history:t reveal_width:1600 reveal_height:1000 ^:nil tags:nil toc:nil
...
variables below will set up the title slide and filter the "Slide:" prefix from
headings; Emacs will ask for permission to load them, as they will execute
code.


# Local Variables:
# org-reveal-title-slide: "<h1 class=\"title\">XDP - challenges and future work</h1><h2
