...
* Notes on distro view                                               :export:

The BPF technology challenge our normal perspective: kernel vs user-space

Current capabilities not good enough
- Distro root-only, even-though it opens user-space attack surface

Lacks community convey on common libs, build and devel environment
- Different hooks and flexibility, fragments FOSS solutions
