...
Areas and markets where XDP is /already being used/

Touch upon *new potential* and opportunities
- e.g. for Virtual-Machines (VM) and Containers

** Market: Anti-DDoS                                                 :export:

@@html:<small>@@
Market: expected grow from [[https://www.marketsandmarkets.com/PressReleases/ddos-protection-mitigation.asp][USD 1.94B in 2018 to USD 4.10 Billion by 2023]]
@@html:</small>@@

The most obvious market for XDP is *anti-DDoS*
...
** Market: L4 Load-balancer                                          :export:

@@html:<small>@@
Global load balancer market size grow from [[https://www.marketsandmarkets.com/Market-Reports/load-balancer-market-236964606.html][USD 2.6B in 2018 to USD 5.0B by 2023]]
@@html:</small>@@
...
* Slide: XDP integrating with other solutions                        :export:
:PROPERTIES:
:reveal_extra_attr: class="mid-slide"
:END:

How can the XDP component be used and integrated into other solutions?
